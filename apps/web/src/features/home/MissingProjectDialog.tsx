  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
      <div className="bg-white rounded-lg p-6 max-w-md space-y-4">
        ...
        <p className="text-sm">
          路徑：<code className="text-xs">{path}</code>
        </p>
        <p className="text-sm text-gray-600">資料夾可能已被移動、刪除或卸載。請選擇下一步：</p>
        <div className="flex flex-col gap-2">
          ...
          <button type="button" onClick={onRemove} className="px-4 py-2 border rounded text-sm">
            從清單移除
          </button>
